...
const PortFolioPieceCover = ({ portfolio }: Props) => {
  ...
  return (
    <div className='grid gap-6 md:gap-10 w-full m-auto max-w-[100rem] md:mb-14'>
      <div
        className='bg-primary-900 rounded-3xl 2xl:rounded-[3rem] border px-2 grid pt-12 bg-fixed'
      ...
      >
        <div className='container-1 w-full'>
          <div className='z-10 grid gap-2'>
            <Typography
              size='body3'
              as='p'
              className='text-white justify-self-start self-start tracking-tight drop-shadow-xl bg-primary-200/70 backdrop-blur-xl max-w-2xl px-2 py-1 rounded-b-sm rounded-t-md m-0 flex gap-3'
            >
          ...
          <div className='z-10 self-end justify-self-start mt-4 flex flex-wrap gap-4 gap-y-0'>
            {portfolio?.liveUrl && (
              <Button
                type='text-light'
                size='large'
                className='px-0 py-2 drop-shadow-md !text-slate-200 hover:!text-white transition-colors'
        ...
        <article className='w-full mt-[-10px] translate-y-10 md:translate-y-14 container-1 px-6 relative py-16 md:pt-24 lg:pt-32 md:pb-20  grid content-center gap-6 min-h-[300px] md:min-h-[450px] lg:min-h-[500px]'>
          <motion.div
