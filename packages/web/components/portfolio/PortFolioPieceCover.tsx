        ...
        <div className='container-1 w-full'>
          <div className='z-10 grid gap-2'>
            <Typography
              size='body3'
              as='p'
              className='text-white justify-self-start self-start tracking-tight drop-shadow-xl bg-secondary-700 backdrop-blur-xl max-w-2xl px-2 py-1 rounded-b-sm rounded-t-md m-0 flex gap-3'
            >
