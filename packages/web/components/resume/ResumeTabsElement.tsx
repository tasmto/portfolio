...
const ResumeTabsElement = (props: Props) => {
  ...
  return (
    <div className='grid grid-cols-5 gap-3 w-full content-stretch'>
      ...
      <article
        id='cv-content'
        className='p-6 py-10 bg-gradient-to-tr rounded-r-3xl from-tertiary-200 to-tertiary-50  col-span-3 h-full flex flex-col items-start justify-center self-stretch text-gray-800'
      >
        <Typography as='p' size='body1'>
